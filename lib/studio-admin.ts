    ...
    launchChecklist: [
      ...
      },
      {
        ...
        items: [
          ...
          { id: "staged-canonical-tables", label: "Create staged canonical item master tables", status: "in_progress", priority: "Required", owner: "Topher", note: "Next: add staged rows and column mappings so weird hospital headers map into MedTrack fields before anything is treated as clean." },
