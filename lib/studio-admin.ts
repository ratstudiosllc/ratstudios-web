    ...
    launchChecklist: [
      ...
      },
      {
        ...
        items: [
          ...
          { id: "model-provider", label: "Add model-provider abstraction for hosted or local LLMs", status: "in_progress", priority: "Recommended", owner: "Bub", note: "Next: add a provider-swappable model layer for hosted enterprise LLMs first, with Azure OpenAI, Bedrock, OpenAI, and later local/on-prem model options." },
