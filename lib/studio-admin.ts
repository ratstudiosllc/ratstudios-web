    ...
    launchChecklist: [
      ...
      },
      {
        ...
        items: [
          ...
          { id: "worker-service", label: "Create worker/job service for agent stages", status: "in_progress", priority: "Required", owner: "Topher", note: "Next: formalize the current synchronous workflow into durable jobs for intake.import_batch, mapping.suggest_columns, profile.batch, normalize.rows, create_findings, and generate_export." },
