    ...
    launchChecklist: [
      ...
      },
      {
        ...
        items: [
          ...
          { id: "rls-tenancy", label: "Apply organization-scoped RLS and access rules", status: "in_progress", priority: "Required", owner: "Topher", note: "Next: replace the initial authenticated policies with organization-scoped access rules for import batches, files, raw rows, staged rows, findings, decisions, evidence, and exports before pilot use." },
        ],
      },
      {
