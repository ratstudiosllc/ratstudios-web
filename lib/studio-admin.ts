  ...
  },
  {
    ...
    launchChecklist: [
      ...
      },
      {
        ...
        items: [
          { id: "workflow-trigger", label: "Trigger cleanup workflow from Start Cleanup in MedTrack", status: "in_progress", priority: "Required", owner: "Topher", note: "Next: separate upload/import from Start Cleanup so MedTrack creates an import batch, enqueues/advances intake, mapping, profile, normalization, and findings stages based on completed jobs and review gates." },
