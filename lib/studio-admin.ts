  ...
  },
  {
    ...
    launchChecklist: [
      ...
      },
      {
        ...
        items: [
          { id: "storage-original-files", label: "Store original item master uploads in Supabase Storage", status: "in_progress", priority: "Required", owner: "Topher", note: "App code and migration are committed in MedTrack: original upload files now archive through an import batch action with checksum, organization, uploader, filename, size, and storage path. Live Supabase migration still needs to be applied before production uploads can use it." },
      ...
      },
      {
        ...
        items: [
          ...
          { id: "export-package", label: "Generate MedTrack Item Master Cleanup Packet", status: "not_started", priority: "Required", owner: "Bub", note: "First export package includes all three agreed outputs: Cleanup Findings CSV, Missing Identifier Report, and Before/After Health Summary. Export only approved findings and keep evidence/audit context attached." },
