      ...
      <div className="mx-auto max-w-6xl px-6 py-10">
        <div className="rounded-[32px] border border-black/5 bg-white p-8 shadow-sm">
          <div className="flex flex-wrap items-start justify-between gap-4">
            <div>
              <p className="text-xs font-semibold uppercase tracking-[0.16em] text-orange-500">Issues</p>
              <h1 className="mt-2 text-3xl font-semibold text-neutral-950">Tracked issues</h1>
              <p className="mt-4 max-w-3xl text-sm text-neutral-600">Full issue list from the real tracker{priorityValue ? ` filtered to ${priorityValue}` : ""}.</p>
            </div>
