      ...
      <div className="mx-auto max-w-7xl px-6 py-10">
        <div className="rounded-[32px] border border-black/5 bg-white p-8 shadow-sm">
          <div className="flex flex-wrap items-start justify-between gap-4">
            <div>
              <p className="text-xs font-semibold uppercase tracking-[0.16em] text-orange-500">Marketing</p>
              <h1 className="mt-2 text-3xl font-semibold text-neutral-950">Marketing by application</h1>
              <p className="mt-4 max-w-3xl text-sm text-neutral-600">This is the studio marketing operating surface for active apps only. Future or inactive concepts do not belong here.</p>
            </div>
            <div className="flex gap-3">
              <Link href="/admin/current-apps" className="rounded-xl border border-black/10 bg-white px-4 py-2 text-sm font-medium text-neutral-700 hover:bg-black/[0.03]">Current apps</Link>
